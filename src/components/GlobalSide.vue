    ...
    <div id="global-side" :class="displayClass">
        <div class="row">
            ...
            <span class="bg-wrap">
                ...
                <span class="i-checkbox-wrap">
                    <input type="checkbox" id="bg-transparent" class="i-checkbox" v-model="sceneStore.transparent">
                    <label for="bg-transparent" class="i-label"></label>
                </span>
                <input type="color" id="color-input" v-model="sceneStore.backgroundColor"
        ...
        <div class="row">
            ...
            <span class="bg-wrap">
                ...
                <span class="i-checkbox-wrap">
                    <input type="checkbox" id="superposition" class="i-checkbox" v-model="appStore.superposition">
        ...
        <div class="row">
            ...
            <ol class="option-bar">
                <li class="option-item">
                    <input type="radio" name="runtime-version" id="runtime-auto" value="0"
                        v-model.number="runtime.version" class="list-option">
        ...
        <div class="row">
            <ol class="option-bar">
                <li v-for="(version, alias) in versions" class="option-item">
                    <input type="radio" name="runtime-version" :id="`runtime-${alias}`" :value="version"
                        v-model.number="runtime.version" class="list-option">
...
const saveImage = () => {
    pixiApp.view.toBlob(async (blob) => {
        if (blob) {
            ...
            // console.log(result)
            if (ipc) {
                const result = await ipc.invoke('save-image', ab, appStore.getActive().name)
                console.log(result)
            }
        } else {
